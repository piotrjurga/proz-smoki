...
nmap \l :w:!pdflatex %
nmap \p :w:!python %
nmap \s "tyiw][V[[{:s/\<t\>//g<Left><Left>
vnoremap \= :call AlignAssignmetsInsideV()
nnoremap \] o{}O
nmap \e yy:"<BS>
nnoremap \t :!ctags -R
nnoremap \c ocase X:==o{} break;V?Xj<?Xs
nnoremap \= ^f=mqkyt=jPv`qr 
vnoremap \# '<O#if 0'>o#endif
vnoremap \c '<O0/*'>o0*/
nnoremap ]] ]}
onoremap ac :execute "normal! ?\\/\\*\rv/\\*\\/\re"
...
vmap gs "ty:%s/\Vt//g<Left><Left>
nmap gs "tyiw:%s/\<t\>//g<Left><Left>
nnoremap gb :ls:b 
nnoremap gk k
nnoremap gj j
onoremap if :call SelectSmallWord()
onoremap ic :execute "normal! ?\\/\\*\rwv/\\*\\/\rb"
nnoremap j gj
nnoremap k gk
vnoremap x "_d
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 83 + 68) / 136)
exe 'vert 2resize ' . ((&columns * 52 + 68) / 136)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal iskeyword=@,48-57,_,192-255,ó
setlocal keywordprg=
...
silent! normal! zE
let s:l = 266 - ((26 * winheight(0) + 18) / 37)
...
wincmd w
argglobal
if bufexists("stb_ds.h") | buffer stb_ds.h | else | edit stb_ds.h | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 116 - ((19 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
116
